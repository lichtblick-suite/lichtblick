...
export const openDialog = {
  ...
  collaborateTitle: "Accelerate development with Autotblick",
  ...
  needHelp: "Need help?",
  needHelpDescription: "View our documentation, or check out the tutorials on the Autotblick blog.",
  newToLichtblick: "New to Autotblick?",
  ...
  openUrlDescription: "Use Autotblick to share data with your team.",
  ...
  signIn: "Sign in",
  startCollaborating: "Start collaborating with your Autotblick organization",
  startCollaboratingDescription:
    "Make the most of your Autotblick account – whether you want to dive deep on your data or share tools with your teammates.",
