...
export const threeDee = {
  ...
  transformPreloadAlertTip:
    "Activating preloading (3D panel/Image -> Transforms -> Settings) is recommended for accurate visualization of transform topics. NOTE: this may impact performance.",
  fixed: "Fixed",
